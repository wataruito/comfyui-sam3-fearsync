...
from .sam3_two_mouse_nodes import NODE_CLASS_MAPPINGS as TWO_MOUSE_MAPPINGS
...
NODE_CLASS_MAPPINGS.update(TWO_MOUSE_MAPPINGS)
...
NODE_DISPLAY_NAME_MAPPINGS.update(TWO_MOUSE_DISPLAY_MAPPINGS)
